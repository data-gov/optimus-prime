...
export const mapToCandidatesVote = (
  name,
  state,
  year,
...
export const findFirstShiftWinner = candidates =>
  calculateShiftWinner(candidates, 1);
...
export const bySecondShift = candidate =>
  candidate.votes.length > BRAZILIAN_STATES;
